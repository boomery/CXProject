...
#import "FileCell.h"
@interface M_ViewFileViewController () <ViewPagerDataSource, ViewPagerDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
